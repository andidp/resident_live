...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { created_at: @agenda.created_at, implementation_date: @agenda.implementation_date, name: @agenda.name, type: @agenda.type, updated_at: @agenda.updated_at, venue: @agenda.venue }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { created_at: @agenda.created_at, implementation_date: @agenda.implementation_date, name: @agenda.name, type: @agenda.type, updated_at: @agenda.updated_at, venue: @agenda.venue }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
